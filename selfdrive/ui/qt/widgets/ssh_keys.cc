...
LateralControlSelect::LateralControlSelect() : AbstractControl("LateralControl [√]", "SELECT (PID/INDI/LQR)", "../assets/offroad/icon_logic.png") {
...
MfcSelect::MfcSelect() : AbstractControl("MFC [√]", "SELECT (LKAS/LDWS/LFA)", "../assets/offroad/icon_mfc.png") {
  label.setAlignment(Qt::AlignVCenter|Qt::AlignRight);
  label.setStyleSheet("color: #e0e879");
  hlayout->addWidget(&label);
...
LongControlSelect::LongControlSelect() : AbstractControl("LongControl [√]", "SELECT (MAD/MAD+LONG)", "../assets/offroad/icon_long.png") {
  label.setAlignment(Qt::AlignVCenter|Qt::AlignRight);
  label.setStyleSheet("color: #e0e879");
  hlayout->addWidget(&label);
